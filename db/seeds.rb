...
# Product Data from spicejungle.com
user1 = User.create(username: "Rose", password_digest: "sisko@cherokee123")
user2 = User.create(username: "Beckie", password_digest: "kimani@456")
user3 = User.create(username: "Linah", password_digest: "lauret@bujuju")
user4 = User.create(username: "Kendi", password_digest: "kathambi@267")
user5 = User.create(username: "Arita", password_digest: "danimbari_bambino")
